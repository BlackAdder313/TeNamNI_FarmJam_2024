...
#include "NeedforWheatSportsCar.h"
#include "NeedforWheatSportsWheelFront.h"
#include "NeedforWheatSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ANeedforWheatSportsCar::ANeedforWheatSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UNeedforWheatSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UNeedforWheatSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UNeedforWheatSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UNeedforWheatSportsWheelRear::StaticClass();

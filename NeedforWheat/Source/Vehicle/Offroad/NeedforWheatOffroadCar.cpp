...
#include "NeedforWheatOffroadCar.h"
#include "NeedforWheatOffroadWheelFront.h"
#include "NeedforWheatOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ANeedforWheatOffroadCar::ANeedforWheatOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UNeedforWheatOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UNeedforWheatOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UNeedforWheatOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UNeedforWheatOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->EngineSetup.EngineBrakeEffect = 3.f;
